...
namespace Kratos
{
    ...
    KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(DF2DX);
    KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(DF3DX);
    KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(DF4DX);
    KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(DF5DX);
    KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(DF6DX);
    KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(DF7DX);
    KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(DF8DX);
    KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(DF9DX);
    ...
    {}
 	...
 	void KratosShapeOptimizationApplication::Register()
 	{
        ...
        KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(DF2DX);
        KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(DF3DX);
        KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(DF4DX);
        KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(DF5DX);
        KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(DF6DX);
        KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(DF7DX);
        KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(DF8DX);
        KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(DF9DX);
