        ...
        for outer_iteration in range(1,self.max_outer_iterations+1):
            for inner_iteration in range(1,self.max_inner_iterations+1):
                ...
                for node in self.design_surface.Nodes:
                    ...
                    DFDALPHA_i = self.bead_height*(raw_gradient[0]*bead_dir[0] + raw_gradient[1]*bead_dir[1] + raw_gradient[2]*bead_dir[2])
                    node.SetSolutionStepValue(DFDALPHA, DFDALPHA_i)
