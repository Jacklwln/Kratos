...
namespace Kratos
{
	...
	KRATOS_DEFINE_3D_VARIABLE_WITH_COMPONENTS(DF2DX);
	KRATOS_DEFINE_3D_VARIABLE_WITH_COMPONENTS(DF3DX);
	KRATOS_DEFINE_3D_VARIABLE_WITH_COMPONENTS(DF4DX);
	KRATOS_DEFINE_3D_VARIABLE_WITH_COMPONENTS(DF5DX);
	KRATOS_DEFINE_3D_VARIABLE_WITH_COMPONENTS(DF6DX);
	KRATOS_DEFINE_3D_VARIABLE_WITH_COMPONENTS(DF7DX);
	KRATOS_DEFINE_3D_VARIABLE_WITH_COMPONENTS(DF8DX);
	KRATOS_DEFINE_3D_VARIABLE_WITH_COMPONENTS(DF9DX);
