...
class GeoImporter( GeoProcessor ):
    ...
    def CreateBoxTetra(self, name_model_part, Xmin, Xmax, Ymin, Ymax, Zmin, Zmax):
        ...
        # sub model part
        bottom = self.ModelPart.CreateSubModelPart("bottom")
        top = self.ModelPart.CreateSubModelPart("top")
        lateral = self.ModelPart.CreateSubModelPart("lateral")
        # node
