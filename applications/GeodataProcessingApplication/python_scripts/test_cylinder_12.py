...
# subtract buildings
building.SubtractBuildingMOD(0.5, 10.0, 0.1, "constant", "STANDARD", "false")			# interpolation = constant; disc_type = STANDARD; remove_regions=false
...
# building.WriteMdpaOutput(mdpa_out_name)
# # subtract buildings
# building.SubtractBuildingMOD(0.2, 10.0, 0.1, "constant", "STANDARD", "false")			# interpolation = linear; disc_type = STANDARD; remove_regions=false
...
building.WriteMdpaOutput(mdpa_out_name)
# subtract buildings
building.SubtractBuildingMOD(0.2, 10.0, 0.1, "exponential", "ISOSURFACE", "true")			# interpolation = exponential; disc_type = ISOSURFACE; remove_regions=true
